	   ...
	   <div class="wrap"> 
		...
		<div class="main-agileits">
			<div class="form-w3agile form1">
				...
				<form:form action="addlsp" method="post">
					<h4>Mã loại sản phẩm</h4>
					<div class="key">
						<input type="text" name="idlsp" required="required">
						<div class="clearfix"></div>
					</div>
					<h4>Tên loại sản phẩm</h4>
					<div class="key">
						<input type="text" name="namelsp" required="required">
						<div class="clearfix"></div>
					</div>
					<input type="submit" class="btn btn-success" value="Thêm Loại sản phẩm">
				</form:form>
					</div>
				</div>
		</div>
