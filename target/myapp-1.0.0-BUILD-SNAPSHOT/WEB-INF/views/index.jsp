	   ...
	   <div class="wrap"> 
			 <div class="cssmenu">
				<ul>
					...
					<c:if test="${empty gettk}">
						<li><a href="login">Log In</a></li> |
						<li><a href="register">Sign Up</a></li>
					</c:if>
					<c:if test="${not empty gettk}">
		...
		<div class="section group">
		  <div class="cont span_2_of_3">
		  	<h2 class="head">Featured Products</h2>
                        <c:forEach var="sp" items="${dssp}" step="3" varStatus="loop">
			<div class="top-box">
                            <c:forEach var="sp" items="${dssp}" begin="${loop.index}" end="${loop.index + 2}">
                                <div class="col_1_of_3 span_1_of_3"> 
                                    <a href="chiTietSP?idsp=${sp.getIdSP()}">
                                       <div class="inner_content clearfix">
                                           <div class="product_image">
                                                   <img src='<c:url value="/resources/images/${sp.url}"/>' alt=""/>
                                           </div>
                                       <div class="sale-box"><span class="on_sale title_shop">New</span></div>	
                                       <div class="price">
                                           <div class="cart-left">
                                                       <p class="title">${sp.tenSP}</p>
                                                       <div class="price1">
                                                         <span class="actual">${sp.giaSP} VND</span>
                                                       </div>
                                                </div>
